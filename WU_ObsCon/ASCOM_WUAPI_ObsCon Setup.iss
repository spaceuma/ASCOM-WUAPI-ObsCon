...
; Generated by EorEquis on 1/16/2018 (UTC)
;
[Setup]
AppID={{59228fff-dafa-4223-a7bd-8258f79abd24}
AppName=ASCOM ASCOM_WUAPI_ObsCon ObservingConditions Driver
AppVerName=ASCOM ASCOM_WUAPI_ObsCon ObservingConditions Driver 1.0.0
AppVersion=1.0.0
...
OutputDir="."
OutputBaseFilename="ASCOM_WUAPI_ObsCon Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\ObservingConditions\ASCOM_WUAPI_ObsCon"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\ObservingConditions\ASCOM_WUAPI_ObsCon"
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\WU_ObsCon.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\WU_ObsCon.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\WU_ObsCon.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\WU_ObsCon.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\WU_ObsCon.dll"""; Flags: runhidden 64bit; Check: IsWin64
